...
export default async function ContactPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: CREAM }}>
      ...
      <main className="relative mx-auto max-w-7xl overflow-hidden px-8 py-20 lg:px-12 lg:py-28">
        ...
        <header className="mb-20 max-w-3xl">
          ...
          >
            Écrivez-nous,
            <br />
            on revient <Mark>sous 24h</Mark>.
          </h1>
          <p
            className="mt-7 max-w-xl text-[16px] leading-[1.75]"
        ...
        {/* ─── I. CANAUX DIRECTS ─── */}
        <section
          className="grid grid-cols-1 gap-12 border-t pt-16 lg:grid-cols-12 lg:gap-16"
        ...
        {/* ─── II. NOS DEUX ANCRES ─── */}
        <section
          className="mt-24 grid grid-cols-1 gap-12 border-t pt-16 lg:grid-cols-12 lg:gap-16"
          style={{ borderColor: HAIRLINE }}
        >
          <div className="lg:col-span-3">
            <span
            ...
            <p className="mt-4 text-[13px] leading-[1.6] text-zinc-700">
        ...
        >
          <div className="lg:col-span-3">
            ...
            <div className="mt-8" style={{ color: CLAY, opacity: 0.65 }}>
              <OliveBranch />
            </div>
          </div>
        ...
        >
          ...
          <blockquote
            className="mx-auto max-w-3xl px-6 text-3xl italic leading-[1.25] md:text-4xl lg:text-[3rem]"
            style={{
              fontFamily: "var(--font-cormorant), serif",
              fontWeight: 500,
              color: INK_WARM,
...
function ContactBlock({
  ...
  return (
    <div className="border-l pl-6" style={{ borderColor: HAIRLINE }}>
      <p
